...
; 0000 002A {
	...
	.CSEG
_ext_int0_isr:
; 0000 002B     // turn the led on if it is off.
; 0000 002C     // turn the led off if it is on.
; 0000 002D     PORTB.0 = !PORTB.0;
	SBIS 0x18,0
	RJMP _0x3
	CBI  0x18,0
	RJMP _0x4
...
; 0000 0031 {
_main:
; 0000 0032     // make the led D1 port output and turn it on.
; 0000 0033     DDRB = 0x01;
	LDI  R30,LOW(1)
	OUT  0x17,R30
; 0000 0034     PORTB = 0x01;
	OUT  0x18,R30
; 0000 0035 
