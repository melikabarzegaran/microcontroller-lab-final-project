...
; 0000 002A {
	...
	.CSEG
_ext_int0_isr:
; 0000 002B     // turn the buzzer on if it is off.
; 0000 002C     // turn the buzzer off if it is on.
; 0000 002D     PORTD.6 = !PORTD.6;
	SBIS 0x12,6
	RJMP _0x3
	CBI  0x12,6
	RJMP _0x4
...
; 0000 0031 {
_main:
; 0000 0032     // make the buzzer BUZZER port output and turn it off.
; 0000 0033     DDRD = 0x40;
	LDI  R30,LOW(64)
	OUT  0x11,R30
...
; 0000 003B     GICR = 0x40;
	...
	OUT  0x3B,R30
; 0000 003C 
; 0000 003D     // make the swith sensitive to any level.
; 0000 003E     MCUCR = 0x01;
	LDI  R30,LOW(1)
	OUT  0x35,R30
; 0000 003F 
